...
<head>
    <meta charset="UTF-8">
    <title>Dijaeg | Dashboard</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>

    <!-- bootstrap select css -->
    <link href="{{asset('assets/admin/js/plugins/bootstrap-select-1.13.14/dist/css/bootstrap-select.min.css')}}"
    ...
    <link href="{{asset('assets/admin/css/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')}}" rel="stylesheet"
          type="text/css"/>
    <!-- NOTY -->
    <link href="{{asset('assets/admin/css/noty.css')}}" rel="stylesheet" type="text/css"/>
    <!-- Theme style -->
...
<script src="{{asset('assets/admin/js/jquery-2.0.2.min.js')}}" type="text/javascript"></script>
...
<script src="{{asset('assets/admin/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')}}"
...
<!-- Bootstrap WYSIHTML5 -->
<script src="{{asset('assets/admin/js/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')}}"
        type="text/javascript"></script>
<!-- iCheck -->
<script src="{{asset('assets/admin/js/plugins/iCheck/icheck.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/admin/js/plugins/bootstrap-select-1.13.14/dist/js/bootstrap-select.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/admin/js/plugins/bootstrap-select-1.13.14/dist/js/i18n/defaults-*.min.js')}}" type="text/javascript"></script>
...
<!-- NOTY -->
<script src="{{asset('assets/admin/js/noty.min.js')}}" type="text/javascript"></script>
